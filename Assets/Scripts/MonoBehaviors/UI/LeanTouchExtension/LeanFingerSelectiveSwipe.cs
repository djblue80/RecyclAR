...
/// <summary>
/// This script is mostly copied from LeanFingerSwipe.cs with an edit on CheckSwipe to detect wrong swipes as well.
/// OnFalseSwipe is also added
/// </summary>
public class LeanFingerSelectiveSwipe : MonoBehaviour {
    ...
    public FingerEvent OnFalseSwipe;
    ...
    protected bool CheckSwipe(LeanFinger finger, Vector2 swipeDelta)
    {
        ...
        if (CheckAngle == true)
        {
            ...
            {
                //Added callback when user performed the wrong swipe 
                if (OnFalseSwipe != null)
                {
                    OnFalseSwipe.Invoke(finger);
                }
                return false;
            }
        }
